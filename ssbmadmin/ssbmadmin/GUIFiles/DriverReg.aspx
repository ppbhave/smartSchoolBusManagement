<%@ Page Title="Driver Registration" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DriverReg.aspx.cs" Inherits="ssbmadmin.GUIFiles.DriverReg" %>
					...
					<div class="logo">
	                 <h1><b>Driver Registration</b></h1>
								...
								<div class="row">
                                    ...
                                    <span id="moname" style="color:red"></span></div>
								</div>
								<br>
								<div class="row">
								<div class="col-sm-2">
								...
								<input type= "text" class="form-control" id="dob" required />
                                    ...
                                    <div class="form-group">
											<div class="col-md-2">
											<label>Bus No.</label>
												<select class="form-control input-sm" id="busno" required />
								...
								<div class="row">
									<div class="col-sm-2">
										...
										<input type="text" class="form-control" id="house" onkeyup="frmchar(this)" required />
									</div>
									<div class="col-sm-2">
