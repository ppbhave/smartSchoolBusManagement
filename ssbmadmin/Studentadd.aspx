<%@ Page Title="Student Addition" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Studentadd.aspx.cs" Inherits="ssbmadmin.Studentadd" %>
...
<script src="jquery-ui-1.12.1/jquery-ui.js"></script>
   ...
   <script src="Scripts/AjaxCalls/ValidationForm.js"></script>
    <script src="Scripts/AjaxCalls/AddStudent.js"></script>
    ...
    <br />
                                 ...
                                 <div class="row">
											<div class="col-sm-2 pull-right">
												<button class="btn btn-primary" type="button" id="saveStudent">
