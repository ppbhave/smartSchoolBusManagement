$(document).ready(function () {
    ...
    $("#getAttendence").click(function () {
        if (document.getElementById('attendenceDate').value != "" || sessionStorage.getItem("studentPK")!="")
        {
            ...
            var dateDuty = $("#attendenceDate").val().split("/");
                ...
                var g_urlPrefix = "http://localhost:59206/";
                var nEntityId = parseInt(sessionStorage.getItem("studentPK"));
                var objToPass = {
                    nEntityId: nEntityId,
                    day: day,
                    month: month,
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: g_urlPrefix + "TAttendence/GetAttendenceByID",
                    data: objToPass,
        ...
        } else alert("ERROR! The date or the student may not be choosen");
    });
