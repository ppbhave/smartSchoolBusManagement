<%@ Page Title="Attendant Registration" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AttendantReg.aspx.cs" Inherits="ssbmadmin.AttendantReg" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  
    <link href="jquery-ui-1.12.1/jquery-ui.css" rel="stylesheet" />
<script src="jquery-ui-1.12.1/external/jquery/jquery.js"></script>
<script src="jquery-ui-1.12.1/jquery-ui.js"></script> 
     <script src="Scripts/AjaxCalls/AddAttendent.js"></script>
    ...
    <div class="header">
					<div class="logo">
	                 <h1><b>Attendant Registration</b></h1>
								  ...
								  <div class="row">
									<div class="col-sm-3">
											<label>Attendent First Name</label>
						...
						<div class="row">
											<div class="col-sm-2 pull-right">
												<button class="btn btn-primary" type="submit" id="saveAttendent">
