<%@ Page Title="Parent Registration" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ParentReg.aspx.cs" Inherits="ssbmadmin.ParentReg" %>
...
<script src="jquery-ui-1.12.1/jquery-ui.js"></script> 
      <script src="Scripts/AjaxCalls/ValidationForm.js"></script>
        <script src="Scripts/AjaxCalls/AddParent.js"></script>
    ...
    <div class="row">
											<div class="col-sm-4+ pull-right">
												<button class="btn btn-primary" type="submit" id="saveParent">
