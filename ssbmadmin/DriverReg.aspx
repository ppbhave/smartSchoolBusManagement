<%@ Page Title="Driver Registration" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DriverReg.aspx.cs" Inherits="ssbmadmin.DriverReg" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   <link href="jquery-ui-1.12.1/jquery-ui.css" rel="stylesheet" />
<script src="jquery-ui-1.12.1/external/jquery/jquery.js"></script>
<script src="jquery-ui-1.12.1/jquery-ui.js"></script>  
      <script src="Scripts/AjaxCalls/AddDriver.js"></script>
   <script src="Scripts/AjaxCalls/ValidationForm.js"></script>
    ...
    <div class="row">
											<div class="col-sm-2 pull-right">
												<button class="btn btn-primary" type="submit" id="saveDriver">
