<%@ Page Title="Attendant Registration" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateAttendent.aspx.cs" Inherits="ssbmadmin.UpdateAttendent" %>
...
<script src="jquery-ui-1.12.1/jquery-ui.js"></script>
   ...
   <script src="Scripts/AjaxCalls/ValidationForm.js"></script>
    <script src="Scripts/AjaxCalls/UpdateAttedent.js"></script>
    <!--  <div class="row">
	                 ...
	                 <h1><b>Attendant Registration</b></h1>
							...
							<div class="col-sm-2">
									...
									<span id="ph2" style="color:red"></span>
										...
										<label>Email ID 1</label>
										  <input type="text" class="form-control" placeholder="example@gmail.com" id="sEmail1" onkeyup="emailval1()" required />
										  <span id="Message1" style="color:red"></span>
									</div>
										<div class="col-sm-4">
										<label>Email ID 2</label>
										  <input type="text" class="form-control" placeholder="example@gmail.com" id="sEmail2" onkeyup="emailval2()" required />
						...
						<div class="row">
											<div class="col-sm-2 pull-right">
												<button class="btn btn-primary" type="Button" id="UpdateAttendent">
